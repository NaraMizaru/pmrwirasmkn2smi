...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'role.admin']], function() {
    ...
    Route::get('/detail/{username}/anggota', [DashboardController::class, 'detailIndex'])->name('admin.dashboard.detail');

    Route::get('/edit/{username}/anggota', [DashboardController::class, 'editIndex'])->name('admin.dashboard.edit');
    Route::post('/edit/{username}/anggota', [DashboardController::class, 'edit'])->name('admin.edit');

    Route::get('/delete/{username}/anggota', [DashboardController::class, 'deleteIndex'])->name('admin.delete.anggota');

    Route::post('/up/{username}/anggota', [DashboardController::class, 'upgradeStatus'])->name('upStatus');
});
...
Route::prefix('download')->group(function() {
    Route::get('/anggota/pdf', [DashboardController::class, 'downloadPdf'])->name('download.pdf');
});
